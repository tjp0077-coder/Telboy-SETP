...
SEED_SCHEDULE = [
    ...
    {"date": "2026-07-27", "day_label": "Mon 27 July", "time": "10:00", "title": "Partner's Tour",
     ...
     "description": "Tour to Rosslyn Castle, The Kelpies, and Linlithgow Palace. Returns by 16:00.",
          "coachTime": "09:45",
          "transportDetails": "09:45 Coach Leaves",
          "maps_url": "https://maps.app.goo.gl/1M2J8i5YVtxDkWVFA",
     "category": "tour"},
    ...
    return {
        ...
        "transport": [
            ...
            {"name": "Walking", "icon": "walk",
             "description": "Central Edinburgh is compact. → Royal Mile ≈ from hotel, 25 min walk or 10 min taxi.",
             "tip": "Cobblestones! Wear comfortable shoes — the Royal Mile is steep in places.",
             "url": "https://www.visitscotland.com/places-to-go/edinburgh/things-to-do/walking"},
